...
const UpdateUserInfo = () => {
  ...
  const [permanentAddress, permanentAddressInput, resetPermanentAddress] =
    useInput("");
  ...
  const [fatherJobTitle, fatherJobTitleInput, resetFatherJobTitle] =
    useInput("");
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
          ...
          {qualifications.map((qualification, index) => (
            <div
              key={index}
              className="grid sm:grid-cols-3 grid-cols-2 gap-6 mb-4"
            >
              <div className="mb-4">
                <label
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleQualificationChange(e, index, "degree")
                  }
                  className="mt-1 block w-full border-gray-300 border-2 py-2 pl-2 rounded-md shadow-sm"
                  placeholder="Degree"
                />
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleQualificationChange(e, index, "institute")
                  }
                  className="mt-1 block w-full border-gray-300 border-2 py-2 pl-2 rounded-md shadow-sm"
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleQualificationChange(e, index, "obtainedMarks")
                  }
                  className="mt-1 block w-full border-gray-300 border-2 py-2 pl-2 rounded-md shadow-sm"
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleQualificationChange(e, index, "totalMarks")
                  }
                  className="mt-1 block w-full border-gray-300 border-2 py-2 pl-2 rounded-md shadow-sm"
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleQualificationChange(e, index, "passingYear")
                  }
                  className="mt-1 block w-full border-gray-300 border-2 py-2 pl-2 rounded-md shadow-sm"
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleQualificationChange(e, index, "percentage")
                  }
                  className="mt-1 block w-full border-gray-300 border-2 py-2 pl-2 rounded-md shadow-sm"
